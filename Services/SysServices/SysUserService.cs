...
namespace Services.SysServices
{
    public class SysUserService : RepositoryBase<SysUser>, ISysUserService
    {
        ...
        {
            IQueryable<SysUser> getAll = base.GetAll();
            IOrderedQueryable<SysUser> ordered = getAll.OrderBy(_sysuser => _sysuser.UserName);
            return ordered;
        }
        ...
        public SysUser GetByUserNamePassword(Guid enterpriseId, string userName, string password)
        {
            ...
            return
                base.GetAllEnt()
                    .FirstOrDefault(
                        a =>
                            a.UserName.Equals(userName) && a.Password.Equals(password));
        }
